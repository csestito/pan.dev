[![Deploy to Firebase Hosting on merge](https://github.com/sserrata/pan.dev/actions/workflows/firebase-hosting-merge.yml/badge.svg)](https://github.com/sserrata/pan.dev/actions/workflows/firebase-hosting-merge.yml) Testing
